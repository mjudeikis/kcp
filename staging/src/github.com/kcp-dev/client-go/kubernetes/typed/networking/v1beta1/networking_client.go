...
type NetworkingV1beta1ClusterInterface interface {
	...
	NetworkingV1beta1ClusterEvictor
...
type NetworkingV1beta1ClusterEvictor interface {
...
func (c *NetworkingV1beta1ClusterClient) Evict(clusterPath logicalcluster.Path) {
