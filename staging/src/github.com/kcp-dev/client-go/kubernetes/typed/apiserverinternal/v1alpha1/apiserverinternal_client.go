...
type InternalV1alpha1ClusterClient struct {
	clientCache kcpclient.Cache[*apiserverinternalv1alpha1.InternalV1alpha1Client]
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*InternalV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*apiserverinternalv1alpha1.InternalV1alpha1Client]{
		NewForConfigAndClient: apiserverinternalv1alpha1.NewForConfigAndClient,
	})
...
func setConfigDefaults(config *rest.Config) {
	gv := apiapiserverinternalv1alpha1.SchemeGroupVersion
