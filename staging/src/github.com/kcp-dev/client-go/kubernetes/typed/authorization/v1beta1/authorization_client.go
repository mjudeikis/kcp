...
type AuthorizationV1beta1ClusterInterface interface {
	...
	AuthorizationV1beta1ClusterEvictor
...
type AuthorizationV1beta1ClusterEvictor interface {
...
func (c *AuthorizationV1beta1ClusterClient) Evict(clusterPath logicalcluster.Path) {
...
// NewForConfig creates a new AuthorizationV1beta1ClusterClient for the given config.
...
// NewForConfigAndClient creates a new AuthorizationV1beta1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AuthorizationV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*authorizationv1beta1.AuthorizationV1beta1Client]{
		NewForConfigAndClient: authorizationv1beta1.NewForConfigAndClient,
	})
...
// NewForConfigOrDie creates a new AuthorizationV1beta1ClusterClient for the given config and
