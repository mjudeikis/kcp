...
type NodeV1ClusterEvictor interface {
	Evict(logicalcluster.Path)
}

// NodeV1ClusterClient is used to interact with features provided by the node.k8s.io group.
...
func setConfigDefaults(config *rest.Config) {
	gv := apinodev1.SchemeGroupVersion
