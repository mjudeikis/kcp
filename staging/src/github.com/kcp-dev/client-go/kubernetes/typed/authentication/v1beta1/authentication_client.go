...
type AuthenticationV1beta1ClusterInterface interface {
	...
	AuthenticationV1beta1ClusterEvictor
...
type AuthenticationV1beta1ClusterEvictor interface {
...
func (c *AuthenticationV1beta1ClusterClient) Evict(clusterPath logicalcluster.Path) {
...
// NewForConfig creates a new AuthenticationV1beta1ClusterClient for the given config.
...
// NewForConfigAndClient creates a new AuthenticationV1beta1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AuthenticationV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*authenticationv1beta1.AuthenticationV1beta1Client]{
		NewForConfigAndClient: authenticationv1beta1.NewForConfigAndClient,
	})
	if _, err := cache.Cluster(logicalcluster.Name("root").Path()); err != nil {
		return nil, err
	}

	return &AuthenticationV1beta1ClusterClient{clientCache: cache}, nil
}

// NewForConfigOrDie creates a new AuthenticationV1beta1ClusterClient for the given config and
...
func setConfigDefaults(config *rest.Config) {
	gv := apiauthenticationv1beta1.SchemeGroupVersion
