...
type CertificatesV1ClusterEvictor interface {
...
// NewForConfig creates a new CertificatesV1ClusterClient for the given config.
...
// NewForConfigAndClient creates a new CertificatesV1ClusterClient for the given config and http client.
...
// NewForConfigOrDie creates a new CertificatesV1ClusterClient for the given config and
...
func setConfigDefaults(config *rest.Config) {
	gv := apicertificatesv1.SchemeGroupVersion
