...
type FlowcontrolV1beta1ClusterInterface interface {
	...
	FlowcontrolV1beta1ClusterEvictor
...
type FlowcontrolV1beta1ClusterEvictor interface {
...
func (c *FlowcontrolV1beta1ClusterClient) Evict(clusterPath logicalcluster.Path) {
...
// NewForConfig creates a new FlowcontrolV1beta1ClusterClient for the given config.
...
// NewForConfigAndClient creates a new FlowcontrolV1beta1ClusterClient for the given config and http client.
...
// NewForConfigOrDie creates a new FlowcontrolV1beta1ClusterClient for the given config and
