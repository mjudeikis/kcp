...
type AdmissionregistrationV1alpha1ClusterInterface interface {
	...
	AdmissionregistrationV1alpha1ClusterEvictor
...
type AdmissionregistrationV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) admissionregistrationv1alpha1.AdmissionregistrationV1alpha1Interface
}

type AdmissionregistrationV1alpha1ClusterEvictor interface {
	Evict(logicalcluster.Path)
}

// AdmissionregistrationV1alpha1ClusterClient is used to interact with features provided by the admissionregistration.k8s.io group.
type AdmissionregistrationV1alpha1ClusterClient struct {
	clientCache kcpclient.Cache[*admissionregistrationv1alpha1.AdmissionregistrationV1alpha1Client]
}
...
func (c *AdmissionregistrationV1alpha1ClusterClient) Evict(clusterPath logicalcluster.Path) {
...
func (c *AdmissionregistrationV1alpha1ClusterClient) ValidatingAdmissionPolicies() ValidatingAdmissionPolicyClusterInterface {
...
func NewForConfig(c *rest.Config) (*AdmissionregistrationV1alpha1ClusterClient, error) {
	config := *c
...
// NewForConfigAndClient creates a new AdmissionregistrationV1alpha1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AdmissionregistrationV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*admissionregistrationv1alpha1.AdmissionregistrationV1alpha1Client]{
		NewForConfigAndClient: admissionregistrationv1alpha1.NewForConfigAndClient,
	})
	if _, err := cache.Cluster(logicalcluster.Name("root").Path()); err != nil {
		return nil, err
	}

	return &AdmissionregistrationV1alpha1ClusterClient{clientCache: cache}, nil
}

// NewForConfigOrDie creates a new AdmissionregistrationV1alpha1ClusterClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *AdmissionregistrationV1alpha1ClusterClient {
