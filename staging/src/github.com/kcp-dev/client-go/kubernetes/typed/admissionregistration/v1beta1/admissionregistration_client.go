...
func (c *AdmissionregistrationV1beta1ClusterClient) MutatingAdmissionPolicyBindings() MutatingAdmissionPolicyBindingClusterInterface {
	return &mutatingAdmissionPolicyBindingsClusterInterface{clientCache: c.clientCache}
}

func (c *AdmissionregistrationV1beta1ClusterClient) MutatingWebhookConfigurations() MutatingWebhookConfigurationClusterInterface {
	return &mutatingWebhookConfigurationsClusterInterface{clientCache: c.clientCache}
}

func (c *AdmissionregistrationV1beta1ClusterClient) ValidatingAdmissionPolicies() ValidatingAdmissionPolicyClusterInterface {
	return &validatingAdmissionPoliciesClusterInterface{clientCache: c.clientCache}
}

func (c *AdmissionregistrationV1beta1ClusterClient) ValidatingAdmissionPolicyBindings() ValidatingAdmissionPolicyBindingClusterInterface {
...
// NewForConfig creates a new AdmissionregistrationV1beta1ClusterClient for the given config.
// NewForConfig is equivalent to NewForConfigAndClient(c, httpClient),
// where httpClient was generated with rest.HTTPClientFor(c).
func NewForConfig(c *rest.Config) (*AdmissionregistrationV1beta1ClusterClient, error) {
	config := *c
...
// NewForConfigAndClient creates a new AdmissionregistrationV1beta1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AdmissionregistrationV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*admissionregistrationv1beta1.AdmissionregistrationV1beta1Client]{
		NewForConfigAndClient: admissionregistrationv1beta1.NewForConfigAndClient,
	})
	if _, err := cache.Cluster(logicalcluster.Name("root").Path()); err != nil {
		return nil, err
	}

	return &AdmissionregistrationV1beta1ClusterClient{clientCache: cache}, nil
}

// NewForConfigOrDie creates a new AdmissionregistrationV1beta1ClusterClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *AdmissionregistrationV1beta1ClusterClient {
...
func setConfigDefaults(config *rest.Config) {
	gv := apiadmissionregistrationv1beta1.SchemeGroupVersion
