...
type StorageV1ClusterEvictor interface {
...
func (c *StorageV1ClusterClient) Evict(clusterPath logicalcluster.Path) {
...
func (c *StorageV1ClusterClient) VolumeAttributesClasses() VolumeAttributesClassClusterInterface {
...
func setConfigDefaults(config *rest.Config) {
	gv := apistoragev1.SchemeGroupVersion
