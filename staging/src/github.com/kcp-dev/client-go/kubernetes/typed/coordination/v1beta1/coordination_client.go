...
type CoordinationV1beta1ClusterInterface interface {
	...
	CoordinationV1beta1ClusterEvictor
	LeasesClusterGetter
...
type CoordinationV1beta1ClusterEvictor interface {
	Evict(logicalcluster.Path)
}

// CoordinationV1beta1ClusterClient is used to interact with features provided by the coordination.k8s.io group.
...
func (c *CoordinationV1beta1ClusterClient) Evict(clusterPath logicalcluster.Path) {
...
func NewForConfig(c *rest.Config) (*CoordinationV1beta1ClusterClient, error) {
	config := *c
...
// NewForConfigAndClient creates a new CoordinationV1beta1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CoordinationV1beta1ClusterClient, error) {
...
// NewForConfigOrDie creates a new CoordinationV1beta1ClusterClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *CoordinationV1beta1ClusterClient {
...
func setConfigDefaults(config *rest.Config) {
	gv := apicoordinationv1beta1.SchemeGroupVersion
