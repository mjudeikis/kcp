...
type RbacV1alpha1ClusterEvictor interface {
...
type RbacV1alpha1ClusterClient struct {
	clientCache kcpclient.Cache[*rbacv1alpha1.RbacV1alpha1Client]
}
...
// NewForConfig creates a new RbacV1alpha1ClusterClient for the given config.
...
// NewForConfigAndClient creates a new RbacV1alpha1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*RbacV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*rbacv1alpha1.RbacV1alpha1Client]{
		NewForConfigAndClient: rbacv1alpha1.NewForConfigAndClient,
	})
	if _, err := cache.Cluster(logicalcluster.Name("root").Path()); err != nil {
		return nil, err
	}

	return &RbacV1alpha1ClusterClient{clientCache: cache}, nil
}

// NewForConfigOrDie creates a new RbacV1alpha1ClusterClient for the given config and
