...
type RbacV1beta1ClusterEvictor interface {
	Evict(logicalcluster.Path)
}

// RbacV1beta1ClusterClient is used to interact with features provided by the rbac.authorization.k8s.io group.
...
func (c *RbacV1beta1ClusterClient) Evict(clusterPath logicalcluster.Path) {
...
func setConfigDefaults(config *rest.Config) {
	gv := apirbacv1beta1.SchemeGroupVersion
