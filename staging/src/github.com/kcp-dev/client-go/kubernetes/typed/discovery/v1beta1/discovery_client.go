...
type DiscoveryV1beta1ClusterClient struct {
	clientCache kcpclient.Cache[*discoveryv1beta1.DiscoveryV1beta1Client]
}
...
// NewForConfig creates a new DiscoveryV1beta1ClusterClient for the given config.
// NewForConfig is equivalent to NewForConfigAndClient(c, httpClient),
// where httpClient was generated with rest.HTTPClientFor(c).
func NewForConfig(c *rest.Config) (*DiscoveryV1beta1ClusterClient, error) {
	config := *c
...
// NewForConfigAndClient creates a new DiscoveryV1beta1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DiscoveryV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*discoveryv1beta1.DiscoveryV1beta1Client]{
		NewForConfigAndClient: discoveryv1beta1.NewForConfigAndClient,
	})
	if _, err := cache.Cluster(logicalcluster.Name("root").Path()); err != nil {
		return nil, err
	}

	return &DiscoveryV1beta1ClusterClient{clientCache: cache}, nil
}

// NewForConfigOrDie creates a new DiscoveryV1beta1ClusterClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *DiscoveryV1beta1ClusterClient {
...
func setConfigDefaults(config *rest.Config) {
	gv := apidiscoveryv1beta1.SchemeGroupVersion
