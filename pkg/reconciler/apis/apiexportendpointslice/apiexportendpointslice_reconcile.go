...
func (r *endpointsReconciler) reconcile(_ context.Context, apiExportEndpointSlice *apisv1alpha1.APIExportEndpointSlice) error {
	...
	// Check if listing shards works. This is a good indicator that the cache is up to date.
	_, err = r.listShards(selector)
	if err != nil {
		conditions.MarkFalse(
			apiExportEndpointSlice,
			apisv1alpha1.APIExportEndpointSliceReadyForURLs,
	...
	conditions.MarkTrue(apiExportEndpointSlice, apisv1alpha1.APIExportEndpointSliceReadyForURLs)
