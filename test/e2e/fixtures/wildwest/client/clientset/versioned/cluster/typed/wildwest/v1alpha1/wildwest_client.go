...
import (
	...
	kcpscheme "github.com/kcp-dev/kcp/test/e2e/fixtures/wildwest/client/clientset/versioned/cluster/scheme"
...
type WildwestV1alpha1ClusterInterface interface {
	...
	WildwestV1alpha1ClusterEvictor
	CowboysClusterGetter
	SherifvesClusterGetter
}

type WildwestV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.WildwestV1alpha1Interface
}

type WildwestV1alpha1ClusterEvictor interface {
	Evict(logicalcluster.Path)
}

// WildwestV1alpha1ClusterClient is used to interact with features provided by the wildwest.dev group.
type WildwestV1alpha1ClusterClient struct {
	clientCache kcpclient.Cache[*kcpv1alpha1.WildwestV1alpha1Client]
}

func (c *WildwestV1alpha1ClusterClient) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.WildwestV1alpha1Interface {
...
func (c *WildwestV1alpha1ClusterClient) Evict(clusterPath logicalcluster.Path) {
...
func NewForConfig(c *rest.Config) (*WildwestV1alpha1ClusterClient, error) {
	config := *c
...
// NewForConfigAndClient creates a new WildwestV1alpha1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*WildwestV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*kcpv1alpha1.WildwestV1alpha1Client]{
...
// NewForConfigOrDie creates a new WildwestV1alpha1ClusterClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *WildwestV1alpha1ClusterClient {
...
func setConfigDefaults(config *rest.Config) {
	gv := kcpwildwestv1alpha1.SchemeGroupVersion
