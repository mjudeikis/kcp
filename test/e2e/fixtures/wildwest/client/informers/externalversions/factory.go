...
type SharedInformerFactory interface {
	...
	Wildwest() kcpwildwest.ClusterInterface
}

func (f *sharedInformerFactory) Wildwest() kcpwildwest.ClusterInterface {
	return kcpwildwest.New(f, f.tweakListOptions)
}
...
type SharedScopedInformerFactory interface {
	...
	Wildwest() kcpwildwest.Interface
}

func (f *sharedScopedInformerFactory) Wildwest() kcpwildwest.Interface {
	return kcpwildwest.NewScoped(f, f.namespace, f.tweakListOptions)
}
